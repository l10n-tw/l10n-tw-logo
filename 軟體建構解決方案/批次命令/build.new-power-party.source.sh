	...
	xmlstarlet edit --pf --ps --inplace --update "//_:g[@inkscape:label='官方版本（LION 版v2）']/@style" --value "display:none" "$new_source_file_with_li"
	xmlstarlet edit --pf --ps --inplace --update "//_:g[@inkscape:label='台澎琉蘭綠東南沙底圖']/@style" --value "display:inline" "$new_source_file_with_li"
